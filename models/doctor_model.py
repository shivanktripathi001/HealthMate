...
#                 u.username as patient_name,
#                 u.email as patient_email,
#                 s.severity_level as symptom_name,
#                 s.description as symptom_description,
#                 h.name as hospital_name,
...
#         appointments = cursor.fetchall()
#         print(f"✓ Fetched {len(appointments)} appointments for doctor {doctor_id}")
#         return appointments
#     except Exception as e:
#         print(f"✗ Error fetching appointments: {e}")
#         import traceback
...
# def get_all_appointments_for_hospital(hospital_id):
#     """Fetch all appointments for a specific hospital (all doctors in that hospital)"""
#     conn = get_connection()
#     cursor = conn.cursor()
...
#         cursor.execute(query, (hospital_id,))
#         appointments = cursor.fetchall()
#         print(f"✓ Fetched {len(appointments)} appointments for hospital {hospital_id}")
#         return appointments
#     except Exception as e:
#         print(f"✗ Error fetching appointments: {e}")
#         import traceback
...
def get_all_doctors():
    ...
    try:
        cursor.execute("""
            SELECT doctor_id, username, name, specialization, email, phone 
            FROM doctors 
            ORDER BY name
        """)
